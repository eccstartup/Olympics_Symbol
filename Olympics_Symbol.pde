...
//  round 1
  ...
  arc(100,100,120,120,0,TAU);
  stroke(255,161,0);//yellow
  arc(100+64+5,100+60,120,120,0,TAU);
  stroke(0,0,0);//black
  arc(100+128+15,100,120,120,0,TAU);
  stroke(0,155,58);//green
  arc(100+192+20,100+60,120,120,0,TAU);
  stroke(225,14,73);//red
  arc(100+256+30,100,120,120,0,TAU);
//  round 2
  stroke(0,122,201);//blue
